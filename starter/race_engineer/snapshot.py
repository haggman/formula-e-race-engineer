...
in proactive radio-call prompts.

# GIVEN — infrastructure, don't edit. Identical to the reference. The
# frontend's engineer loop calls this to pin the triggering instant, so the
# agent doesn't re-fetch a world that has moved on at replay speed.
"""
from __future__ import annotations

from starter.race_engineer.config import OUR_CAR_NUMBER, race_time_to_wall_ns
