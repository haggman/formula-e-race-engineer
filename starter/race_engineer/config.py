...
# GIVEN — infrastructure, don't edit. Identical to the reference
# (solution/race_engineer/config.py). The time-bridge constant below is
# correctness, not creativity: get it wrong and every history query leaks
# the future or returns nothing.
